      ...
      try
      {
        ...
        if (((double)videoSize.Width / videoSize.Height >= 2.5) && (videoSize.Width >= 2560)) // we have Full HD SBS 
        {
          GUIGraphicsContext.IsFullHD3DFormat = true;
            ...
            if (((double)videoSize.Width / videoSize.Height <= 1.5) && (videoSize.Height >= 1440)) // we have Full HD TAB
          {
            GUIGraphicsContext.IsFullHD3DFormat = true;
          }
          ...
          else
          {
            if (GUIGraphicsContext.IsFullHD3DFormat)
            {
              if ((double)_prevVideoWidth / _prevVideoHeight >= 2.5) // we have Full HD SBS 
                ...
                if ((double)_prevVideoWidth / _prevVideoHeight <= 1.5) // we have Full HD TAB
                {
